...
namespace UI
{
	...
	UIService::UIService()
	{
		...
		linked_list_controller = nullptr;  //by me
		game_play_ui_controller = nullptr;
	...
	void UIService::createControllers()
	{
		...
		linked_list_controller = new LinkedListSelectionScreen();
		game_play_ui_controller = new GameplayUIController();
	}
	...
	void UIService::initializeControllers()
	{
		...
		linked_list_controller->initialize();
		game_play_ui_controller->initialize();
	}
	...
	IUIController* UIService::getCurrentUIController()
	{
		...
		case GameState::LINKED_LIST_SELECTION:
			return linked_list_controller;
		case GameState::GAMEPLAY:
			return game_play_ui_controller;
		default:
			return nullptr;	
		}
	}
	...
	void UIService::destroy()
	{
		...
		delete(linked_list_controller);
		delete(game_play_ui_controller);
	}
}